...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <?php if (auth_rol() === 'admin'): // Super-usuario plataforma ?>
        <a href="<?= base_url('clientes') ?>" class="nav-item <?= str_contains($_SERVER['REQUEST_URI'], '/clientes') ? 'active' : '' ?>">
            <span class="nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21h18M5 21V7l8-4v18M19 21V11l-6-4"/><path d="M9 9h.01M9 13h.01M9 17h.01"/></svg></span>
            <span class="nav-label">Clientes</span>
            <span class="nav-tooltip">Clientes (organizaciones) — super-usuario</span>
        </a>
        <?php endif; ?>
